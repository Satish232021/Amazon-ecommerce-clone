...
import {deliveryOptions} from '../data/delivery-object.js';
...
renderOrderSummary();/* to re run / re-generate the code for auto  refresh of page whenever we done different actions*/
